...
const joint_geometry_1 = new THREE.BoxGeometry( 0.1*ratio, 0.1*ratio, 0.1*ratio )
const joint_mesh_1 = new THREE.Mesh( joint_geometry_1, joint_material_0 )
//scene.add( joint_mesh_0 )
joint_mesh_1.position.y = 0
joint_mesh_1.position.z = 0
joint_mesh_1.position.x = 0*ratio
joint_mesh_1.rotation.x = 0
scene.add( joint_mesh_1 )
//joint_mesh_1.visible = false
...
const referenceColor = new THREE.Color(0xaed6f1)
const cart_material_1 = new THREE.MeshStandardMaterial( { color: cart['color'] } )
cart_material_1.transparent = true
cart_material_1.opacity = 0.5
cart_material_1.metalness = 0      
cart_material_1.roughness = 1
cart_material_1.emissiveIntensity = 0
const cart_mesh_1 = new THREE.Mesh( cart_geometry, cart_material_1 )
cart_mesh_1.position.y = 0
cart_mesh_1.position.z = 0
cart_mesh_1.position.x = 5*ratio
scene.add( cart_mesh_1 )
joint_mesh_1.add(cart_mesh_1)
...
const joint_material_2 = new THREE.MeshStandardMaterial( { color: referenceColor} )
joint_material_2.transparent = true
joint_material_2.opacity =0
joint_material_2.metalness = 0      
joint_material_2.roughness = 1
joint_material_2.emissiveIntensity = 0
const joint_mesh_2 = new THREE.Mesh(joint_geometry, joint_material_2 )
scene.add( joint_mesh_2 )
cart_mesh_1.add(joint_mesh_2)
joint_mesh_2.position.y = 0
joint_mesh_2.position.z = 0
joint_mesh_2.position.x = 0.65*ratio
joint_mesh_2.rotation.x = Math.PI
...
const rPoleColor= new THREE.Color(0x000000)
const pole_material_1 = new THREE.MeshStandardMaterial( { color: rPoleColor } )
pole_material_1.transparent = true
pole_material_1.opacity = 0.5
const pole_mesh_1 = new THREE.Mesh( pole_geometry, pole_material_1 )
scene.add( pole_mesh_1 )
joint_mesh_2.add(pole_mesh_1)
pole_mesh_1.position.y = -1.5*ratio
pole_mesh_1.position.z = 0
pole_mesh_1.position.x = 0
...
fontLoader.load(
    ...
    addFont('PolyU Virtual Lab',0,12,0,0,Math.PI/2,0,0.8,0x000000,'PolyU') 
    addFont('CartPole Control',0,10,0,0,Math.PI/2,0,0.7,0x000000,'CartPole Control')
    addFont('Free Drop',0,8,0,0,Math.PI/2,0,0.7,0x000000,'Free Drop')
    addFont('Static Mode',0,8,0,0,Math.PI/2,0,0.7,0x000000,'Static Mode')
    addFont('Pole Placement',0,8,0,0,Math.PI/2,0,0.7,0x000000,'Pole Placement')
    addFont('Energy Shaping',0,8,0,0,Math.PI/2,0,0.7,0x000000,'Energy Shaping')
...
camera.position.set(20.88154222241871*1.1,4.414799505750304*1.1,-0.06606443898450855*1.1)
...
const updateReferenceCart = () =>
{   
    joint_mesh_1.rotation.y = debugObject.targetX/10*Math.PI
}
control_folder.add(debugObject,'targetX').name('Target Position x').min(-10).max(10).onChange(updateReferenceCart)
